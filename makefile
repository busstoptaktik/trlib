...
ALLSRC =  $(SRCS) $(GEOMETRIC_GEODESYSRC) $(PHYSICAL_GEODESYSRC) $(UTILITIESSRC) $(LORDSRC) $(DEPSRC) $(APISRC) $(UTILSSRC) $(PARSINGSRC) $(STRONGSRC)
...
ALLOBJ =  $(OBJS) $(GEOMETRIC_GEODESYOBJ) $(PHYSICAL_GEODESYOBJ) $(UTILITIESOBJ) $(LORDOBJ) $(DEPOBJ) $(APIOBJ) $(UTILSOBJ) $(PARSINGOBJ) $(STRONGOBJ)
.PHONY: pre
