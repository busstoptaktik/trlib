...
ALLSRC =  $(SRCS) $(GEOMETRIC_GEODESYSRC) $(PHYSICAL_GEODESYSRC) $(UTILITIESSRC) $(GENERIC_TRANSFORMATION) $(LORDSRC) $(DEPSRC) $(APISRC) $(UTILSSRC) $(PARSINGSRC) $(STRONGSRC)
...
ALLOBJ =  $(OBJS) $(GEOMETRIC_GEODESYOBJ) $(PHYSICAL_GEODESYOBJ) $(UTILITIESOBJ) $(GENERIC_TRANSFORMATION) $(LORDOBJ) $(DEPOBJ) $(APIOBJ) $(UTILSOBJ) $(PARSINGOBJ) $(STRONGOBJ)
.PHONY: pre
