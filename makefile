...
ALLSRC =  $(SRCS) $(GEOMETRIC_GEODESYSRC) $(PHYSICAL_GEODESYSRC) $(LORDSRC) $(DEPSRC) $(APISRC) $(UTILSSRC) $(PARSINGSRC) $(STRONGSRC)
...
ALLOBJ =  $(OBJS) $(GEOMETRIC_GEODESYOBJ) $(PHYSICAL_GEODESYOBJ) $(LORDOBJ) $(DEPOBJ) $(APIOBJ) $(UTILSOBJ) $(PARSINGOBJ) $(STRONGOBJ)
.PHONY: pre
