...
ALLSRC =  $(GEOMETRIC_GEODESYSRC) $(PHYSICAL_GEODESYSRC) $(UTILITIESSRC) $(GENERIC_TRANSFORMATION) $(SPECIFIC_TRANSFORMATION) $(METADATASRC) $(LORDSRC) $(DEPSRC) $(APISRC) $(UTILSSRC) $(PARSINGSRC) $(STRONGSRC)
...
ALLOBJ =  $(GEOMETRIC_GEODESYOBJ) $(PHYSICAL_GEODESYOBJ) $(UTILITIESOBJ) $(GENERIC_TRANSFORMATION) $(SPECIFIC_TRANSFORMATION) $(METADATAOBJ) $(LORDOBJ) $(DEPOBJ) $(APIOBJ) $(UTILSOBJ) $(PARSINGOBJ) $(STRONGOBJ)
.PHONY: pre
